...
class TransactionRecyclerAdapter(options: FirestoreRecyclerOptions<TransactionPost>) :
    FirestoreRecyclerAdapter<TransactionPost, TransactionRecyclerAdapter.TransactionHolder>(options) {
